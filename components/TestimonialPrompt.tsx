            ...
            <div className="relative bg-surface-container-lowest rounded-2xl shadow-2xl max-w-md w-full p-6 animate-in zoom-in-95 slide-in-from-bottom-4 duration-300">
                ...
                {isSubmitted ? (
                    ...
                    <div className="text-center py-8">
                        ...
                        <h2 className="text-2xl font-bold text-on-surface mb-2">{t('thank_you_title')}</h2>
                        <p className="text-on-surface-variant mb-6">
                            {t('thank_you_desc')}
                        </p>
                        <button
                            onClick={handleClose}
                            className="bg-primary text-white px-6 py-2 rounded-xl font-bold hover:bg-primary-container transition-colors"
                        >
                            {t('close')}
                        </button>
                    </div>
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            <textarea
                                ...
                                className="w-full p-3 border border-outline-variant/30 rounded-xl focus:ring-2 focus:ring-primary outline-none resize-none h-24 text-sm"
                                maxLength={500}
                            />
                            <p className="text-xs text-on-surface-variant text-right mt-1">{text.length}/500</p>
                        </div>
                            ...
                            {['role_parent', 'role_class_rep', 'role_teacher'].map((rKey) => (
                                <button
                                    ...
                                    className={`flex-1 py-2 px-3 rounded-lg text-sm font-medium transition-colors ${role === t(rKey)
                                        ? 'bg-primary-container/20 text-primary border-2 border-primary/40'
                                        : 'bg-surface-container-high text-on-surface-variant border-2 border-transparent hover:bg-surface-container-high'
                                        }`}
                                >
                                    {t(rKey)}
                                </button>
                        ...
                        <input
                            ...
                            className="w-full p-3 border border-outline-variant/30 rounded-xl focus:ring-2 focus:ring-primary outline-none text-sm"
                        />
                        ...
                        <button
                            ...
                            className="w-full bg-primary text-white py-3 rounded-xl font-bold hover:bg-primary-container transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
                            {isSubmitting ? (
