...
export default function DashboardPage() {
    ...
    return (
        <div className="min-h-screen p-4 space-y-8 pb-24 pt-24">
                ...
                <section className="space-y-3">
                    <div className="flex items-center justify-between">
                        <h2 className="text-lg font-semibold" style={{ color: 'var(--text-primary)' }}>
                            {t('dashboard.latest_announcement')}
                        </h2>
            ...
            <section className="space-y-3">
                <h2 className="text-lg font-semibold" style={{ color: 'var(--text-primary)' }}>
                    {t('dashboard.upcoming_birthdays')}
                </h2>
                ...
                <div className="grid grid-cols-1 gap-3">
                    {upcomingBirthdays.length > 0 ? (
                        ...
                        <p className="text-sm text-center py-4" style={{ color: 'var(--text-tertiary)' }}>{t('dashboard.no_birthdays')}</p>
                    )}
                </div>
            </section>
        </div>
